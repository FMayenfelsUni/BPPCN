...
public class Node implements Comparable<Node> {
	...
	private double reputation;      //added line

	private long exclusionTime;      //added line
	...
	public Node(int index, Graph graph) {
		...
		this.reputation = 1.0;        //added reputation
		this.exclusionTime = 0;	//added timeout
	}
	...
	//implemented gettermethod for reputation
	public double getReputation() {
        return this.reputation;
    }

	//implemented settermethod for reputation

	public void setReputation(double reputation) {
        this.reputation = reputation;
    }

	//implemented gettermethod for exclusionTime
	public double getExclusionTime() {
        return this.exclusionTime;
    }

	//implemented settermethod for exclusionTime

	public void setExclusionTime(long exclusionTime) {
